 ...
 */
final class Version20200327084224 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ct404particular (id INT AUTO_INCREMENT NOT NULL, id_ct404_role_id INT DEFAULT NULL, id_ct404_commercial_id INT DEFAULT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, address VARCHAR(50) NOT NULL, zip_code VARCHAR(5) NOT NULL, city VARCHAR(50) NOT NULL, mail VARCHAR(50) NOT NULL, phone_number INT NOT NULL, password VARCHAR(60) NOT NULL, pseudo VARCHAR(50) NOT NULL, clef VARCHAR(100) NOT NULL, actif TINYINT(1) NOT NULL, date_registeur DATETIME NOT NULL, INDEX IDX_59A290B96D7E3993 (id_ct404_commercial_id), INDEX IDX_59A290B961DDAC3C (id_ct404_role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ct404_product (id INT AUTO_INCREMENT NOT NULL, id_ct404_supplier_id INT DEFAULT NULL, idct404_category_id INT DEFAULT NULL, product_name VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, price NUMERIC(15, 2) NOT NULL, quantity_stock VARCHAR(11) NOT NULL, quantity_of_alerte VARCHAR(11) NOT NULL, category_name VARCHAR(255) NOT NULL, INDEX IDX_DABC5B58B56FCC00 (idct404_category_id), INDEX IDX_DABC5B583688741C (id_ct404_supplier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
