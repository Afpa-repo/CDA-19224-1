...
const developmentPlugins = [require('stylelint')()];
...
const productionPlugins = [require('cssnano')({ preset: 'default' })];

// Exports the postcss config depending on NODE_ENV
if (process.env.NODE_ENV === 'production') {
    module.exports = {
        plugins: [...generalPlugins, ...productionPlugins],
    };
} else {
    module.exports = {
        plugins: [...developmentPlugins, ...generalPlugins],
    };
}
